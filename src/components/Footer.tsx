...
const Footer = () => {
  ...
  return (
    ...
    >
      {/* This div now only contains the content that should be max-width (7xl) 
        and centered (mx-auto). The marquee will be placed outside this.
      */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-8 items-end">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              >
                <div className="p-2 rounded-full bg-muted group-hover:bg-black transition-colors duration-200 ease-in-out">
              ...
              {/* Twitter Icon */}
              <motion.a
                href="https://x.com/irozon_official"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <div className="p-2 rounded-full bg-muted group-hover:bg-black transition-colors duration-200 ease-in-out">
                  <Twitter className="w-5 h-5 text-foreground group-hover:text-white" />
                </div>
              </motion.a>
            </div>
          </div>
      ...
      {/* Moving text marquee - MOVED OUTSIDE the max-w-7xl container */}
      <div className="overflow-hidden py-6 px-6 border-b border-border">
        <motion.div
          animate={{ x: [0, -1000] }}
          transition={{
            duration: 20,
