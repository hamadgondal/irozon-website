...
export const SERVICES_DETAIL = [
  ...
  },
  {
    ...
    gradient: "from-green-500/10 to-emerald-500/10",
    iconBg: "bg-gradient-to-br from-green-500 to-emerald-500",
    shortDescription: `Need a stunning website or powerful online tool for your business? We build lightning-fast, secure web solutions that not only look fantastic but are built to grow your leads, streamline operations, and stay online — every single day`,
    longDescription: `Every great business needs a powerful digital home. Whether you're starting from scratch or need an upgrade, we design and build flexible, future-proof web solutions that are tailored to your exact needs—no complicated jargon, just professional results. We don't just create pretty pages; we craft secure, fast, and responsive digital platforms that act as a 24/7 engine for your business, driving leads, supporting customers, and managing your daily operations.`,
    details: [
  ...
  },
  {
    ...
    gradient: "from-green-500/10 to-emerald-500/10",
    iconBg: "bg-gradient-to-br from-green-500 to-emerald-500",
    shortDescription: `Ready to stand out and look professional? We create complete, memorable brand identities—from your logo and colors to the exact words you use. Get a unified, instantly recognizable presence.`,
  ...
  },
  {
    ...
    gradient: "from-green-500/10 to-emerald-500/10",
    iconBg: "bg-gradient-to-br from-green-500 to-emerald-500",
    shortDescription: `We ensure your product is easy and enjoyable to use while looking professional. We craft intuitive designs, from app screens to marketing graphics, so your users stay happy and engaged.`,
    longDescription: `Good design isn't just about looking pretty—it's about making things effortless for your users. Whether it's a website, a mobile app, or a marketing flyer, we focus on creating visuals that are both stunning and incredibly intuitive. We blend strategic thinking with artistic skill to craft engaging User Interfaces (UI) and smooth User Experiences (UX). The result is a design that keeps your customers engaged, lowers frustration, and turns visitors into loyal clients.`,
    details: [
